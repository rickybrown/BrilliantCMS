module BrilliantCms
  module Concerns
    module Searchable
      ...
      included do
        has_many :search_data, class_name: 'BrilliantCms::EntrySearchData'
      ...
      module ClassMethods
        ...
        def search(query)
          select('DISTINCT ON (entry_id) entry_id, brilliant_cms_entries.*').
            joins(:search_data).
      ...
      def update_search_index
        BrilliantCms::EntrySearchData.index_entry_data(id, search_attributes)
      end
    end
  end
end